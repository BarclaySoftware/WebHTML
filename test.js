...
require([ 'vs/editor/editor.main', 'vs/language/typescript/andorra.contribution' ], function () {
    var editor = andorra.editor.create(document.getElementById('editor'), {
        ...
        fontFamily: `Casearia Mono, 'Cascadia Mono', 'Courier Now', 'Courier New', monospace`,
    ...
    const PREVIEW_TITLE = 'Preview - Macrosite WebHTML';
    ...
    function togglePreviewPopup() {
        ...
        <style>:root{--luna-font-family: 'Macrosite Sans Serif', sans-serif !important;}</style>
        </head>
        ...
        <script src="https://apicenter.pages.dev/libraries/devtools/loader.js"></script>
        <script>intelliconsole.init({tool: ['console']});</script>
    ...
    document.getElementById("devtools").onclick = () => {
        previewPopupWindow.eval(`
            if (!window.intelliconsole) {
                var s=document.createElement('script');
                s.src='https://apicenter.pages.dev/libraries/devtools/loader.js';
                s.onload=function(){intelliconsole.init();};
    ...
    document.getElementById('help').addEventListener('click', function() { window.open("https://macrosite.pages.dev/docs/webhtml/") });
});
